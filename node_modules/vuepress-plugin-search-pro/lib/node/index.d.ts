...
type SearchIndexStore = Record<string, SearchIndex<IndexItem, string>>;
...
interface DeprecatedSearchProOptions {
    /**
...
interface SearchProOptions extends DeprecatedSearchProOptions {
    /**
...
declare const searchProPlugin: (options: SearchProOptions, legacy?: boolean) => PluginFunction;

export { type CustomFieldIndexID, type CustomFieldIndexItem, type DeprecatedSearchProOptions, IndexField, type IndexItem, type LocaleIndex, type PageIndexId, type PageIndexItem, type SearchIndexStore, type SearchProCustomFieldFormatter, type SearchProCustomFieldOptions, type SearchProHotKeyOptions, type SearchProIndexOptions, type SearchProLocaleConfig, type SearchProLocaleData, type SearchProOptions, type SectionIndexId, type SectionIndexItem, searchProPlugin };
